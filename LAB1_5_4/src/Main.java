public class Main {
    public static void main(String[] args) {
        ...
        bst.insert(new Student("Равлик", "Таісія", "Миронівна", 45632, true));
        ...
        bst.insert(new Student("Сергієнко", "Валерія", "Віталіївна", 83295, false));
        ...
        bst.insert(new Student("Куць", "Дарія", "Ігорівна", 34174, false));
        bst.insert(new Student("Воронін", "Кирило", "Петрович", 72914, true));
        ...
        System.out.println("Пошук за ключем 'Олена': " + bst.search("Олена"));
    }
}